...
import { Eye, EyeOff, Check, X, Mail, Info } from 'lucide-react';
import { addEmail, saveEmailOnlyLogin, updateUserPassword } from '@/apiCalls';
...
const Security = () => {
  ...
  const [isEmailOnlyLogin, setIsEmailOnlyLogin] = useState(false);
      ...
      {userInfo?.email && userInfo?.walletAddress && (
        <div className='bg-gray-900 p-8 rounded-lg shadow-xl w-full mx-auto max-w-md'>
          <Switch
            ...
            valueLabel={isEmailOnlyLogin ? 'Enabled' : 'Disabled'}
